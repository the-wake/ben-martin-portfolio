  ...
  const [projects] = useState([
    {
      ...
      description: 'One of the toughtest parts of running a tabletop role-playing game is simply keeping track of every last creature, trinket, and secret. Dungeon Delver is a full-stack MERN website that makes tracking a sprawling campaign as easy as clicking a button. This application takes the tedium out of running campaigns by letting users quickly and easily do things like create dungeons and rooms, manage monsters, update stats, across any number of campaigns. (Refactored from a previous version using Handlebars and Sequelize.)',
      image: imgDelver,
    ...
    },
    {
      ...
      description: 'A fully back-end application run via the command line (Node.js). Users can create and update departments, job titles, and employees. The back-end MySQL database enables useful and powerful connections to be created between data points for easy reference and correlation. (Back-end only; no live deployment.)',
      image: imgEms,
    ...
    },
    {
      ...
      description: 'This back-end Mongoose-based API has a robust suite of queries allowing users to create accounts, post thoughts, and comment on each other\'s posts. The NoSQL nature of the database allows for greater flexibility in the data, and allows easy creation of connections between data points. (Back-end only; no live deployment.)',
